...
>(subgraph: (
    ...
    const subgraphToQueryString = (relationshipKey: RelationshipKey, relation: any, path: string, previousNodeType: string) => {
        ...
        variableStateEntries.push(
            [`n_${path}_state`, nodeSchema.parse(removeRelationshipEntries(relation))],
